  ...
  <body class=" dark-theme ">
    ...
    <header class=" page-header   content-always-light header-basic" id="page-header">
      <div class="header-search-box">
        ...
        <form class="nav-search search-form" role="search" method="get" action="home-2.html#">
      ...
      <div class="container">
        <nav class="menu-navbar">
          <div class="header-logo"><a class="logo-link" href="home-2.html#"><img class="logo-img light-logo" loading="lazy" src="assets/images/logo/logo-light.png" alt="logo"/><img class="logo-img  dark-logo" loading="lazy" src="assets/images/logo/logo-dark.png" alt="logo"/></a></div>
          <div class="links menu-wrapper ">
            <ul class="list-js links-list">
              <li class="menu-item has-sub-menu"><a class="menu-link   active" href="home-2.html#0">home <i class="fas fa-plus  plus-icon"> </i></a>
                <ul class="sub-menu ">
              ...
              <li class="menu-item has-sub-menu"><a class="menu-link  " href="home-2.html#0">services<i class="fas fa-plus  plus-icon"> </i></a>
                <ul class="sub-menu ">
              ...
              <li class="menu-item has-sub-menu"><a class="menu-link  " href="home-2.html#0">portfolio <i class="fas fa-plus  plus-icon"> </i></a>
                <ul class="sub-menu ">
              ...
              <li class="menu-item has-sub-menu"><a class="menu-link  " href="home-2.html#0">blog<i class="fas fa-plus  plus-icon"> </i></a>
                <ul class="sub-menu ">
              ...
              <li class="menu-item has-sub-menu"><a class="menu-link  " href="home-2.html#0">pages<i class="fas fa-plus  plus-icon"> </i></a>
                <ul class="sub-menu ">
            ...
            <div class="container"> 
              <div class="hero-text-area  content-always-light   ">
                <div class="row ">
                  <div class="col-12   ">
                    <div class="hero-social-icons mb-3 ">
                      <div class="sc-wrapper dir-row sc-flat">
                        <ul class="sc-list">
                          <li class="sc-item " title="Facebook"><a class="sc-link" href="home-2.html#0" title="social media icon"><i class="fab fa-facebook-f sc-icon"></i></a></li>
                          <li class="sc-item " title="youtube"><a class="sc-link" href="home-2.html#0" title="social media icon"><i class="fab fa-youtube sc-icon"></i></a></li>
                          <li class="sc-item " title="instagram"><a class="sc-link" href="home-2.html#0" title="social media icon"><i class="fab fa-instagram sc-icon"></i></a></li>
                          <li class="sc-item " title="twitter"><a class="sc-link" href="home-2.html#0" title="social media icon"><i class="fab fa-twitter sc-icon"></i></a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-12   ">
                    <div class="cta-links-area"><a class=" btn-solid cta-link cta-link-primary  " href="home-2.html#0">start now</a><a class=" btn-outline cta-link  " href="home-2.html#0">Contact us</a></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="container">
              <div class="hero-text-area  content-always-light   ">
                <div class="row">
                  ...
                  <div class="col-12   ">
                    <div class="cta-links-area "><a class=" btn-solid cta-link  cta-link-primary  " href="home-2.html#0">start now</a>
        ...
        <div class=" clients-logos d-flex align-items-center justify-content-around flex-wrap">
          ...
          <div class="swiper-container">
            <div class="swiper-wrapper clients-logo-wrapper wow fadeIn " data-wow-delay=".02s">
              ...
              -->
              <div class="swiper-slide">
                <div class="client-logo  "><a href="home-2.html#0"><img class="img-fluid logo " loading="lazy" src="assets/images/clients-logos/1-white.png" alt=" "></a></div>
              </div>
              <div class="swiper-slide">
                <div class="client-logo "><a href="home-2.html#0"><img class="img-fluid logo " loading="lazy" src="assets/images/clients-logos/2-white.png" alt=" "></a></div>
              </div>
              <div class="swiper-slide">
                <div class="client-logo "><a href="home-2.html#0"><img class="img-fluid logo " loading="lazy" src="assets/images/clients-logos/3-white.png" alt=" "></a></div>
              </div>
              <div class="swiper-slide">
                <div class="client-logo "><a href="home-2.html#0"><img class="img-fluid logo " loading="lazy" src="assets/images/clients-logos/4-white.png" alt=" "></a></div>
              </div>
              <div class="swiper-slide">
                <div class="client-logo "><a href="home-2.html#0"><img class="img-fluid logo " loading="lazy" src="assets/images/clients-logos/5-white.png" alt=" "></a></div>
              </div>
              <div class="swiper-slide">
                <div class="client-logo "><a href="home-2.html#0"><img class="img-fluid logo " loading="lazy" src="assets/images/clients-logos/6-white.png" alt=" "></a></div>
              </div>
              <div class="swiper-slide">
                <div class="client-logo "><a href="home-2.html#0"><img class="img-fluid logo " loading="lazy" src="assets/images/clients-logos/7-white.png" alt=" "></a></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-12  col-md-6 col-xl-3  mx-auto price-plan ">
            <div class="plan    wow fadeInUp  " data-wow-delay=".1s ">
              ...
              <div class="plan-cta"><a class="cta-btn btn-outline " href="home-2.html#0">select plan  </a></div>
            </div>
          </div>
          <!--Second-plan-->
          <div class="col-12  col-md-6 col-xl-3  mx-auto price-plan ">
              ...
              <div class="row">
                <div class="col-12 col-lg-4 ">
                  <div class="post-box">     <a class="post-link" href="post-single.html" title="How litespeed technology works to speed up your site "> 
                    ...
                    <div class="post-summary">
                      <div class="post-info"><a class="info post-cat" href="home-2.html#"> <i class="bi bi-bookmark icon"></i>hosting</a><a class="info post-author" href="home-2.html#"> <i class=" bi bi-person icon"></i>Allan Moore</a></div>
                ...
                <div class="col-12 col-lg-4 ">         
                  <div class="post-box">     <a class="post-link" href="post-single.html" title="give your website a new look and feel with themes"> 
                    ...
                    <div class="post-summary">
                      <div class="post-info"><a class="info post-cat" href="home-2.html#"> <i class="bi bi-bookmark icon"></i>web dev</a><a class="info post-author" href="home-2.html#"> <i class=" bi bi-person icon"></i>mhmd amin</a></div>
                      <div class="post-text"><a class="post-link" href="post-single.html"> 
                ...
                <div class="col-12 col-lg-4 ">         
                  <div class="post-box">     <a class="post-link" href="post-single.html" title="the role of domain names in SEO world explained "> 
                    ...
                    <div class="post-summary">
                      <div class="post-info"><a class="info post-cat" href="home-2.html#"> <i class="bi bi-bookmark icon"></i>SEO</a><a class="info post-author" href="home-2.html#"> <i class=" bi bi-person icon"></i>yusuf amin</a></div>
                      <div class="post-text"><a class="post-link" href="post-single.html"> 
      ...
      <div class="container">
        <div class="row footer-cols">
          ...
          <div class="col-6 col-lg-2  footer-col ">
            ...
            <div class="footer-col-content-wrapper">
              <ul class="footer-menu ">
                <li class="footer-menu-item"><i class="bi bi-arrow-right icon "></i><a class="footer-menu-link" href="home-2.html#0">Google</a>
                </li>
                <li class="footer-menu-item"><i class="bi bi-arrow-right icon "></i><a class="footer-menu-link" href="home-2.html#0">Dribbble</a>
                </li>
                <li class="footer-menu-item"><i class="bi bi-arrow-right icon "></i><a class="footer-menu-link" href="home-2.html#0">linkedIn</a>
                </li>
                <li class="footer-menu-item"><i class="bi bi-arrow-right icon "></i><a class="footer-menu-link" href="home-2.html#0">wikipedia</a>
                </li>
              </ul>
            </div>
          </div>
          <div class="col-6 col-lg-2 footer-col ">
            ...
            <div class="footer-col-content-wrapper">
              <ul class="footer-menu">
                <li class="footer-menu-item"><i class="bi bi-arrow-right icon "></i><a class="footer-menu-link" href="home-2.html#0">support</a>
                </li>
                <li class="footer-menu-item"><i class="bi bi-arrow-right icon "></i><a class="footer-menu-link" href="home-2.html#0">dashboard</a>
                </li>
                <li class="footer-menu-item"><i class="bi bi-arrow-right icon "></i><a class="footer-menu-link" href="home-2.html#0">drivers</a>
                </li>
                <li class="footer-menu-item"><i class="bi bi-arrow-right icon "></i><a class="footer-menu-link" href="home-2.html#0">projects</a>
                </li>
              </ul>
            </div>
          </div>
            ...
            <div class="col-12 col-md-6 d-flex justify-content-start">
              <p class="creadits">
                ...
                Created by:
                           ...
                           <a class="link" href="home-2.html#0">amin-themes</a>
              </p>
            </div>
            <div class="col-12 col-md-6 d-flex justify-content-end">
              <div class="terms-links"><a href="home-2.html#0">Terms of Use </a>
                | <a href="home-2.html#0">Privacy Policy.</a>
              </div>
            </div>
          </div>
        </div>
