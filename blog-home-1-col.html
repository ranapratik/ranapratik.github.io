  ...
  <body class=" dark-theme ">
    ...
    <header class=" page-header   inner-page-header header-basic" id="page-header">
      <div class="header-search-box">
        ...
        <form class="nav-search search-form" role="search" method="get" action="blog-home-1-col.html#">
      ...
      <div class="container">
        <nav class="menu-navbar">
          <div class="header-logo"><a class="logo-link" href="blog-home-1-col.html#"><img class="logo-img light-logo" loading="lazy" src="assets/images/logo/logo-light.png" alt="logo"/><img class="logo-img  dark-logo" loading="lazy" src="assets/images/logo/logo-dark.png" alt="logo"/></a></div>
          <div class="links menu-wrapper ">
            <ul class="list-js links-list">
              <li class="menu-item has-sub-menu"><a class="menu-link  " href="blog-home-1-col.html#0">home <i class="fas fa-plus  plus-icon"> </i></a>
                <ul class="sub-menu ">
                  <li class="menu-item sub-menu-item"><a class="menu-link sub-menu-link  " href="index.html">home 1</a></li>
                  <li class="menu-item sub-menu-item"><a class="menu-link sub-menu-link  " href="home-2.html">home 2 [ Slider 1 ]</a></li>
                  <li class="menu-item sub-menu-item"><a class="menu-link sub-menu-link  " href="home-3.html">home 3 [ Slider 2 ]</a></li>
              ...
              <li class="menu-item has-sub-menu"><a class="menu-link  " href="blog-home-1-col.html#0">services<i class="fas fa-plus  plus-icon"> </i></a>
                <ul class="sub-menu ">
              ...
              <li class="menu-item has-sub-menu"><a class="menu-link  " href="blog-home-1-col.html#0">portfolio <i class="fas fa-plus  plus-icon"> </i></a>
                <ul class="sub-menu ">
              ...
              <li class="menu-item has-sub-menu"><a class="menu-link   active" href="blog-home-1-col.html#0">blog<i class="fas fa-plus  plus-icon"> </i></a>
                <ul class="sub-menu ">
              ...
              <li class="menu-item has-sub-menu"><a class="menu-link  " href="blog-home-1-col.html#0">pages<i class="fas fa-plus  plus-icon"> </i></a>
                <ul class="sub-menu ">
        ...
        <div class="hero-text-area centerd">
          ...
          <nav aria-label="breadcrumb ">
            <ul class="breadcrumb wow fadeInUp" data-wow-delay=".6s">
              <li class="breadcrumb-item"><a class="breadcrumb-link" href="blog-home-1-col.html#0"><i class="bi bi-house icon "></i>home</a></li>
              ...
              <div class="row">
                <div class="col-12 ">
                  <div class="post-box">     <a class="post-link" href="post-single.html" title="How litespeed technology works to speed up your site "> 
                    ...
                    <div class="post-summary">
                      <div class="post-info"><a class="info post-cat" href="blog-home-1-col.html#"> <i class="bi bi-bookmark icon"></i>hosting</a><a class="info post-author" href="blog-home-1-col.html#"> <i class=" bi bi-person icon"></i>Allan Moore</a></div>
                ...
                <div class="col-12 ">         
                  <div class="post-box">     <a class="post-link" href="post-single.html" title="give your website a new look and feel with themes"> 
                    ...
                    <div class="post-summary">
                      <div class="post-info"><a class="info post-cat" href="blog-home-1-col.html#"> <i class="bi bi-bookmark icon"></i>web dev</a><a class="info post-author" href="blog-home-1-col.html#"> <i class=" bi bi-person icon"></i>mhmd amin</a></div>
                      <div class="post-text"><a class="post-link" href="post-single.html"> 
                ...
                <div class="col-12 "> 
                  <div class="post-box">     <a class="post-link" href="post-single.html" title="the role of domain names in SEO world explained "> 
                    ...
                    <div class="post-summary">
                      <div class="post-info"><a class="info post-cat" href="blog-home-1-col.html#"> <i class="bi bi-bookmark icon"></i>SEO</a><a class="info post-author" href="blog-home-1-col.html#"> <i class=" bi bi-person icon"></i>yusuf amin</a></div>
                      <div class="post-text"><a class="post-link" href="post-single.html"> 
                ...
                <div class="col-12 "> 
                  <div class="post-box">     <a class="post-link" href="post-single.html" title="we are able to building your dream website"> 
                    ...
                    <div class="post-summary">
                      <div class="post-info"><a class="info post-cat" href="blog-home-1-col.html#"> <i class="bi bi-bookmark icon"></i>design</a><a class="info post-author" href="blog-home-1-col.html#"> <i class=" bi bi-person icon"></i>mhmd amin</a></div>
                      <div class="post-text"><a class="post-link" href="post-single.html"> 
                ...
                <div class="col-12 "> 
                  <div class="post-box">     <a class="post-link" href="post-single.html" title="data analysis and the big impact on industry"> 
                    ...
                    <div class="post-summary">
                      <div class="post-info"><a class="info post-cat" href="blog-home-1-col.html#"> <i class="bi bi-bookmark icon"></i>features</a><a class="info post-author" href="blog-home-1-col.html#"> <i class=" bi bi-person icon"></i>fairouz amin</a></div>
                      <div class="post-text"><a class="post-link" href="post-single.html"> 
                ...
                <div class="col-12 "> 
                  <div class="post-box">     <a class="post-link" href="post-single.html" title="helping others can boost you happiness"> 
                    ...
                    <div class="post-summary">
                      <div class="post-info"><a class="info post-cat" href="blog-home-1-col.html#"> <i class="bi bi-bookmark icon"></i>cloud</a><a class="info post-author" href="blog-home-1-col.html#"> <i class=" bi bi-person icon"></i>yusuf amin</a></div>
                      <div class="post-text"><a class="post-link" href="post-single.html"> 
                ...
                <div class="col-12">
                  ...
                  <nav class="ma-pagination">
                    <ul class="pagination justify-content-center">
                      <li class="ma-page-item deactive-page-item"><a class="ma-page-link " href="blog-home-1-col.html#" title="Previous Page"><i class="bi bi-chevron-left icon "></i></a></li>
                      <li class="ma-page-item active"><a class="ma-page-link " href="blog-home-1-col.html#">1 </a></li>
                      <li class="ma-page-item  "><a class="ma-page-link " href="blog-home-1-col.html#">2 </a></li>
                      <li class="ma-page-item  "><a class="ma-page-link " href="blog-home-1-col.html#">3 </a></li>
                      <li class="ma-page-item  "><a class="ma-page-link " href="blog-home-1-col.html#">4 </a></li>
                      <li class="ma-page-item  "><a class="ma-page-link " href="blog-home-1-col.html#">5 </a></li>
                      <li class="ma-page-item  "><a class="ma-page-link " href="blog-home-1-col.html#">6 </a></li>
                      <li class="ma-page-item"><a class="ma-page-link" href="blog-home-1-col.html#" title="Next Page"><i class="bi bi-chevron-right icon "></i></a></li>
                    </ul>
                  </nav>
                </div>
              </div>
          ...
          <div class="col-12 col-xl-4 ">
            <div class="blog-sidebar">
              ...
              <div class="search sidebar-box">
                <form class="search-form" action="blog-home-1-col.html#">
              ...
              <div class="cats sidebar-box">
                ...
                <ul class="sidebar-list cats-list  ">
                  <li class="cat-item"><a class="cat-link" href="blog-home-1-col.html#">data<span class="cat-count">17</span></a></li>
                  <li class="cat-item"><a class="cat-link" href="blog-home-1-col.html#">web dev <span class="cat-count">25</span></a></li>
                  <li class="cat-item"><a class="cat-link" href="blog-home-1-col.html#">hosting<span class="cat-count">14</span></a></li>
                  <li class="cat-item"><a class="cat-link" href="blog-home-1-col.html#">domain names<span class="cat-count">73</span></a></li>
                  <li class="cat-item"><a class="cat-link" href="blog-home-1-col.html#">apps<span class="cat-count">36</span></a></li>
                </ul>
              </div>
              <!--Recent posts  -->
              <div class="recent-posts sidebar-box">
                ...
                <ul class="sidebar-list r-posts-list ">
                  <li class="r-post-item"><a class="r-post-link" href="blog-home-1-col.html#">
              ...
              <div class="tags sidebar-box">
                ...
                <ul class="sidebar-list tags-list ">
                  <li class="tag-item"><a class="tag-link" href="blog-home-1-col.html#">wordpress</a></li>
                  <li class="tag-item"><a class="tag-link" href="blog-home-1-col.html#">data analysis</a></li>
                  <li class="tag-item"><a class="tag-link" href="blog-home-1-col.html#">hosting</a></li>
                  <li class="tag-item"><a class="tag-link" href="blog-home-1-col.html#">design</a></li>
                  <li class="tag-item"><a class="tag-link" href="blog-home-1-col.html#">developing</a></li>
                  <li class="tag-item"><a class="tag-link" href="blog-home-1-col.html#">consulting</a></li>
                  <li class="tag-item"><a class="tag-link" href="blog-home-1-col.html#">design</a></li>
                  <li class="tag-item"><a class="tag-link" href="blog-home-1-col.html#">concept</a></li>
                  <li class="tag-item"><a class="tag-link" href="blog-home-1-col.html#">features</a></li>
                  <li class="tag-item"><a class="tag-link" href="blog-home-1-col.html#">services</a></li>
                  <li class="tag-item"><a class="tag-link" href="blog-home-1-col.html#">portfolio</a></li>
                  <li class="tag-item"><a class="tag-link" href="blog-home-1-col.html#">testmonials</a></li>
                </ul>
              </div>
              <div class="follow-us sidebar-box">
                ...
                <div class="sc-wrapper dir-row sc-size-32">
                  <ul class="sc-list">
                    <li class="sc-item " title="Facebook"><a class="sc-link" href="blog-home-1-col.html#0" title="social media icon"><i class="fab fa-facebook-f sc-icon"></i></a></li>
                    <li class="sc-item " title="youtube"><a class="sc-link" href="blog-home-1-col.html#0" title="social media icon"><i class="fab fa-youtube sc-icon"></i></a></li>
                    <li class="sc-item " title="instagram"><a class="sc-link" href="blog-home-1-col.html#0" title="social media icon"><i class="fab fa-instagram sc-icon"></i></a></li>
                    <li class="sc-item " title="twitter"><a class="sc-link" href="blog-home-1-col.html#0" title="social media icon"><i class="fab fa-twitter sc-icon"></i></a></li>
                  </ul>
                </div>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row footer-cols">
          <div class="col-12 col-md-8 col-lg-4  footer-col "><img class="img-fluid footer-logo" loading="lazy" src="assets/images/logo/logo-colored.png" alt="logo"/>
            ...
            <div class="form-area ">
              <div class="mailchimp-form ">
                <form class="one-field-form" method="post" action="blog-home-1-col.html#0">
          ...
          <div class="col-6 col-lg-2  footer-col ">
            ...
            <div class="footer-col-content-wrapper">
              <ul class="footer-menu ">
                <li class="footer-menu-item"><i class="bi bi-arrow-right icon "></i><a class="footer-menu-link" href="blog-home-1-col.html#0">Google</a>
                </li>
                <li class="footer-menu-item"><i class="bi bi-arrow-right icon "></i><a class="footer-menu-link" href="blog-home-1-col.html#0">Dribbble</a>
                </li>
                <li class="footer-menu-item"><i class="bi bi-arrow-right icon "></i><a class="footer-menu-link" href="blog-home-1-col.html#0">linkedIn</a>
                </li>
                <li class="footer-menu-item"><i class="bi bi-arrow-right icon "></i><a class="footer-menu-link" href="blog-home-1-col.html#0">wikipedia</a>
                </li>
              </ul>
            </div>
          </div>
          <div class="col-6 col-lg-2 footer-col ">
            ...
            <div class="footer-col-content-wrapper">
              <ul class="footer-menu">
                <li class="footer-menu-item"><i class="bi bi-arrow-right icon "></i><a class="footer-menu-link" href="blog-home-1-col.html#0">support</a>
                </li>
                <li class="footer-menu-item"><i class="bi bi-arrow-right icon "></i><a class="footer-menu-link" href="blog-home-1-col.html#0">dashboard</a>
                </li>
                <li class="footer-menu-item"><i class="bi bi-arrow-right icon "></i><a class="footer-menu-link" href="blog-home-1-col.html#0">drivers</a>
                </li>
                <li class="footer-menu-item"><i class="bi bi-arrow-right icon "></i><a class="footer-menu-link" href="blog-home-1-col.html#0">projects</a>
                </li>
              </ul>
            </div>
          </div>
            ...
            <div class="col-12 col-md-6 d-flex justify-content-start">
              <p class="creadits">
                ...
                Created by:
                           ...
                           <a class="link" href="blog-home-1-col.html#0">amin-themes</a>
              </p>
            </div>
            <div class="col-12 col-md-6 d-flex justify-content-end">
              <div class="terms-links"><a href="blog-home-1-col.html#0">Terms of Use </a>
                | <a href="blog-home-1-col.html#0">Privacy Policy.</a>
              </div>
            </div>
          </div>
        </div>
